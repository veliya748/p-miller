                ...
                <Paper square={true} style={{ backgroundColor: lightGreen[100], height: 650, overflowX: "hidden", overflowY: "hidden" }}>
                    <Grid container >
                        ...
                        <Grid item xs>
                            ...
                            <img src={healthcare} alt="healthcare" style={{ float: "right", marginTop: 40, height: 200, marginRight: 300 }} />
                            <img src={hearth} alt="hearth" style={{ float: "right", marginTop: 150, height: 200, marginRight: 250 }} />
                        </Grid>
                    </Grid>
                </Paper>
            </ScrollableAnchor>
